...
class DetailCustomerApprovalPage extends StatefulWidget {
  const DetailCustomerApprovalPage({Key? key}) : super(key: key);

  @override
  State<DetailCustomerApprovalPage> createState() =>
      _DetailPoAppCustomervalPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
              onPressed: () {
                Get.offAll(() => ListCustomerApprovel());
              },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(DateFormat('yyyy-MM-dd')
                          .format(customer.activePeriodFrom)),
                      SizedBox(
                        height: 15,
                      ),
                      Text(
                      ...
                      Text(DateFormat('yyyy-MM-dd')
                          .format(customer.activePeriodTo)),
                      ...
                      child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              approvedController.approveCustomer(customer.id);
                            },
                      ...
                      child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              final approvedController =
                                  Get.put(ApprovedController());
                              approvedController.rejectedCustomer(customer.id);
                            },
                            style: ElevatedButton.styleFrom(
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(12)),
