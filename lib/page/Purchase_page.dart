...
class _PurchasePageState extends State<PurchasePage> {
  ...
  Future<void> fetchKemasan(id) async {
    var kemasanList = await poController.getKemasan(id);
    setState(() {
      itemsKemasanIds =
