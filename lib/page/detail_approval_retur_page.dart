...
import 'package:pt_sage/page/list_keluhan_approvel.dart';
...
class _DetailReturApprovalPage extends State<DetailReturApprovalPage> {
  ...
  void fetchKeluhan() async {
    ...
    setState(() {
      detailKeluhan = fetchKeluhan;
      print(detailKeluhan!.customer.customersName);
    });
  }
                        ...
                        Container(
                          ...
                          child: SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  KeluhanPelangganController().approveRetur(
                                      keluhan.id,
                                      KeluhanPelangganController
                                          .keluhanControllerRetur.text);
                                  print(keluhan.id);
                                },
