...
class ApprovelPurchaseOrder {
  ...
  factory ApprovelPurchaseOrder.fromJson(Map<String, dynamic> json) {
    return ApprovelPurchaseOrder(
      kodePo: json['kode_po'],
...
class ApprovelPurchaseOrderList {
  final List<ApprovelPurchaseOrder> orders;

  ApprovelPurchaseOrderList({required this.orders});

  factory ApprovelPurchaseOrderList.fromJson(List<dynamic> json) {
    return ApprovelPurchaseOrderList(
      orders: json.map((item) => ApprovelPurchaseOrder.fromJson(item)).toList(),
    );
  }
